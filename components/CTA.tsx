      ...
      >
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-[#3A3A3A] leading-relaxed">
            Jag har tagit emot din förfrågan och återkommer vanligtvis inom
            1–2 arbetsdagar.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            >
              ...
              <option value="Inom några månader">
                Inom några månader
              </option>
          ...
          <div>
            ...
            >
              ...
              <option value="Under 10 000 kr">
                Under 10 000 kr
              </option>

              <option value="10 000–20 000 kr">
                10 000–20 000 kr
              </option>

              <option value="20 000+ kr">
                20 000+ kr
              </option>
            </select>
          </div>
